...
const Baga = () => {
  ...
  <h1>
    <p>Welcome to ilya's homework!</p>

    <p>These terms and conditions outline the rules and regulations for the use of ilya's testsite's Website,
    ...
    <p>As long as the website and the information and services on the website are provided free of charge, we will
        not
        be liable for any loss or damage of any nature.</p></h1>
    </div>
  )
}
